...
tf2.compat.v1.flags.DEFINE_string('image_size', '256', 'Image size to train.')
tf2.compat.v1.flags.DEFINE_string('model_file', 'fast-style-model.ckpt-done', '')
# tf2.compat.v1.flags.DEFINE_string('image_file', 'source/03.jpg', '')
        ...
        try:
            ...
            with tf.Graph().as_default():
                with tf.Session().as_default() as sess:
                    ...
                    # 保证'generated'文件夹存在
                    generated_file = 'generated/' + name_list[i] + '_74000' + '_resource.jpg'
