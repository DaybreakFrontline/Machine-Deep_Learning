...
from just_project.style_transfer.vgg import vgg_16
from just_project.style_transfer.vgg import vgg_arg_scope
from just_project.style_transfer.vgg_preprocessing import preprocess_image
from just_project.style_transfer.vgg_preprocessing import unprocess_image
from just_project.style_transfer import reader
from just_project.style_transfer import model
from just_project.style_transfer import utils
from just_project.style_transfer.losses import gram
from just_project.style_transfer import losses
import os
import time
...
# 构建损失网络
# tensorboard --logdir="just_project\style_transfer\models\wave"
            ...
            try:
                while not coord.should_stop():
                    ...
                    if step % 75 == 0:
                        ...
                        writer.flush()
                    if step % 1000 == 0:
                        saver.save(sess, os.path.join(training_path, FLAGS.style_image_name + '_fast-style-model.ckpt'), global_step=step)
